...
public interface TaskDao {
    ...
    Page<Task> findByTitleDescStatusPriorityDueDate(String taskTitle, String taskStatus, String taskPriority,
    ...
    Page<TaskHistory> findByTaskTitleAndDueDate(String taskTitle, Date taskDueDateFrom, Date taskDueDateTo, PageRequest dueDate);
